...
<body class="bg-gray-100 font-family-karla flex">
    ...
    <aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
        <div class="p-4">
            ...
            <button onclick="location.href='<?php echo e(route('admin.post.create')); ?>';"
        ...
        <nav class="text-white text-base font-semibold">
            <a href="<?php echo e(route('admin.index')); ?>"
                class="<?php echo e(request()->routeIs('admin.index') ? 'active-nav-link' : 'opacity-75 hover:opacity-100'); ?> flex items-center text-white py-4 pl-6 nav-item">
                <i class="fas fa-tachometer-alt mr-3"></i>
                Dashboard
            </a>
                <a href="<?php echo e(route('admin.category.index')); ?>"
                    class="<?php echo e(request()->routeIs('*.category.*') ? 'active-nav-link' : 'opacity-75 hover:opacity-100'); ?> flex items-center text-white py-4 pl-6 nav-item">
                    <i class="fas fa-sticky-note mr-3"></i>
                    Kategorie
                </a>
                <a href="<?php echo e(route('admin.gallery.index')); ?>" class="flex items-center text-white py-4 pl-6 nav-item">
                    <i class="fas fa-images mr-3"></i>
                    Galerie
                </a>
            <a href="<?php echo e(route('admin.post.index')); ?>"
                class="<?php echo e(request()->routeIs('*.post.*') ? 'active-nav-link' : 'opacity-75 hover:opacity-100'); ?> flex items-center text-white  py-4 pl-6 nav-item">
            ...
            <a href="<?php echo e(route('admin.tag.index')); ?>"
                class="<?php echo e(request()->routeIs('*.tag.*') ? 'active-nav-link' : 'opacity-75 hover:opacity-100'); ?> flex items-center text-white  py-4 pl-6 nav-item">
                <i class="fas fa-tag mr-3"></i>
                Tagy
            </a>
            <a href="<?php echo e(route('admin.page.index')); ?>"
            class="<?php echo e(request()->routeIs('*.page.*') ? 'active-nav-link' : 'opacity-75 hover:opacity-100'); ?> flex items-center text-white  py-4 pl-6 nav-item">
            <i class="far fa-file mr-3"></i>
            Stránky
        </a>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin-only')): ?>
                <a href="<?php echo e(route('admin.role.index')); ?>"
                    class="<?php echo e(request()->routeIs('*.role.*') ? 'active-nav-link' : 'opacity-75 hover:opacity-100'); ?> flex items-center text-white  py-2 pl-6 nav-item">
                    <i class="fas fa-user-shield mr-3"></i>
                    Role
                </a>
                <a href="<?php echo e(route('admin.user.index')); ?>"
                    class="<?php echo e(request()->routeIs('*.user.*') ? 'active-nav-link' : 'opacity-75 hover:opacity-100'); ?> flex items-center text-white  py-3 pl-6 nav-item">
                    <i class="fas fa-users mr-3"></i>
                    Uživatelé
                </a>
                <a href="<?php echo e(route('admin.setting.index')); ?>"
                    class="<?php echo e(request()->routeIs('*.setting.*') ? 'active-nav-link' : 'opacity-75 hover:opacity-100'); ?> flex items-center text-white  py-4 pl-6 nav-item">
        ...
        <header class="w-full items-center bg-white py-2 px-6 hidden sm:flex">
            ...
            <div class="relative text-lg bg-transparent text-gray-800 rounded">
                <div class="flex items-center border-b border-teal-500 py-2">
                    <form action="<?php echo e(route('admin.post.search')); ?>" method="GET">
            ...
            <div x-data="{ isOpen: false }" class="relative w-1/2 flex justify-end">
                ...
                <div x-show="isOpen" class="absolute w-32 bg-white rounded-lg shadow-lg py-2 mt-16">
                    <a href="<?php echo e(route('admin.account.index')); ?>" class="block px-4 py-2 account-link hover:text-white">Účet</a>
        ...
        <header x-data="{ isOpen: false }" class="w-full bg-sidebar py-5 px-6 sm:hidden">
            ...
            <nav :class="isOpen ? 'flex' : 'hidden'" class="flex flex-col pt-4">
                <a href="index.html" class="flex items-center active-nav-link text-white py-2 pl-4 nav-item">
                    ...
                    <a href="<?php echo e(route('admin.gallery.index')); ?>" class="flex items-center text-white opacity-75 hover:opacity-100 py-2 pl-4 nav-item">
                        <i class="fas fa-images mr-3"></i>
                        Galerie
                    </a>
                <a href="<?php echo e(route('admin.post.index')); ?>"
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.13.0/js/all.min.js"
        ...
        <?php if(request()->routeIs('*.post.create') || request()->routeIs('*.post.edit')): ?>
...
<script>
    ...
    $('#summernote').summernote({
        ...
        callbacks: {
            ...
            onImageUpload: function (files) {
                ...
                $.ajax({
                    url: "<?php echo e(route('admin.post.uploadImage')); ?>",
                    method: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
    ...
    $('#title').change(function () {
        $.get('<?php echo e(route('admin.post.getslug')); ?>', { 'titulek': $(this).val() }, function (data) {
            $('#slug').val(data.slug);
        });
    });
});
    ...
    <?php if(request()->routeIs('*.category.create') || request()->routeIs('*.category.edit')): ?>
        ...
        <script>
            $('#name').change(function(e) {
                $.get('<?php echo e(route('admin.category.getslug')); ?>', {
                        'název': $(this).val()
                    },
                    function(data) {
                        $('#slug').val(data.slug);
    ...
    <?php if(request()->routeIs('*.page.create') || request()->routeIs('*.page.edit')): ?>
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.3/jquery.min.js"></script>

<!-- Slug generator -->
<script>
    $('#name').change(function(e) {
        $.get('<?php echo e(route('admin.page.getslug')); ?>', {
                'name': $(this).val()
            },
            function(data) {
                $('#slug').val(data.slug);
...
<?php /**PATH C:\Users\bohda\OneDrive\Plocha\Obec\resources\views/admin/layouts/admin.blade.php ENDPATH**/ ?>