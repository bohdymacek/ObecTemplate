...
<?php endif; ?>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin-login')): ?>
...
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('profile.edit'))]); ?>
                            <?php echo e(__('Přihlašovací údaje')); ?>
...
<?php /**PATH C:\Users\bohda\OneDrive\Plocha\Obec\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>