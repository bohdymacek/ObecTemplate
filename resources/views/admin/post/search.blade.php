        ...
        <main class="w-full flex-grow p-6">
            ...
            <div class="w-full mt-12">
                <p class="text-xl pb-3 flex items-center">
                    <i class="fas fa-list mr-3"></i> Výsledky Hledání
                </p>
                @if($posts->isNotEmpty())
                <div class="w-full bg-white text-left p-4 mb-2">Nalezeno {{ $posts->total() }} Záznamů V Aktualitách</div>
                ...
                {!! $posts->links() !!}
                @else
                <div class="w-full bg-red-500 text-left p-4 mb-2 text-white">Žádné Záznamy nenalezeny..</div>
                @endif
        </main>
    </div>
</x-admin-layout>
