<x-admin-layout>
    ...
    <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6">
            <h1 class="w-full text-3xl text-black pb-6">Profil Uživatele</h1>

            <div class="w-full mt-12">
                <p class="text-xl pb-3 flex items-center">
                    <i class="fas fa-list mr-3"></i> Detaily Uživatele
                </p>
                <div class="flex items-center justify-center mb-4">
                    ...
                    <form method="POST" action="{{ route('admin.account.update', $user->id) }}" enctype="multipart/form-data">
                        ...
                        <label class="ml-4 block text-sm text-gray-600" for="message">Vyberte Obrázek: </label>
                ...
                <button class="px-4 py-1 text-white font-light tracking-wider bg-green-600 rounded">Aktualizovat
                    Profil</button>
                </form>
            </div>
        </main>
