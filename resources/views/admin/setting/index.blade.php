<x-admin-layout>
    ...
    <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6">
            <h1 class="w-full text-3xl text-black pb-6">Nastavení Stránky</h1>

            <div class="w-full mt-12">
                <p class="text-xl pb-3 flex items-center">
                    <i class="fas fa-list mr-3"></i> Detaily Nastavení
                </p>

                @if ($setting->updated_at != null)
                <div class="w-full bg-white text-left p-4 mb-2">Poslední Úprava {{ $setting->updated_at }}</div>
                @endif
                ...
                <div class="mb-1">
                    <label for="site_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Název Stránky</label>
                ...
                <div class="mb-1">
                    <label for="description" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Popis Stránky</label>
                ...
                <div class="mb-1">
                    <label for="about" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">O Stránce</label>
                ...
                <div class="mb-1">
                    <label for="copy_right" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Autor V Zápatí</label>
                ...
                <button class="px-4 py-1 text-white font-light tracking-wider bg-green-600 rounded">Aktualizovat Nastavení</button>
                </form>
            </div>
        </main>
    </div>
