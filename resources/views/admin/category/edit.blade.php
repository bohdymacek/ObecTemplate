<x-admin-layout>
    ...
    <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6">
            <h1 class="w-full text-3xl text-black pb-6">Upravit Kategorii</h1>
            ...
            <div class="w-full mt-12">
                ...
                <div class="mb-1">
                    <label for="slug" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Zkratka Kategorie</label>
                ...
                <button class="px-4 py-1 text-white font-light tracking-wider bg-green-600 rounded">Aktualizovat Kategorii</button>
                </form>
            </div>
        </main>
    </div>
