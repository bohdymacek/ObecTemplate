<x-admin-layout>
    ...
    <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6">
            <h1 class="w-full text-3xl text-black pb-6">Upravit Roli Uživatele</h1>

            <div class="w-full mt-12">
                <p class="text-xl pb-3 flex items-center">
                    <i class="fas fa-list mr-3"></i> Detaily Role
                </p>
                <form method="POST" action="{{ route('admin.user.update', $user->id ) }}">
                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                        <div class="mb-1">
                            <label for="role" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Název Role</label>
                ...
                <button class="px-4 py-1 text-white font-light tracking-wider bg-green-600 rounded">Aktualizovat Roly</button>
                </form>
            </div>
        </main>
    </div>
